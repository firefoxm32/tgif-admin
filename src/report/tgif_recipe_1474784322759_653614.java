/*
 * Generated by JasperReports - 9/25/16 1:18 PM
 */
 ...
 *
 */
public class tgif_recipe_1474784322759_653614 extends JREvaluator
{
...
new java.lang.Double(  ((((java.lang.Double)variable_sub_total.getValue()).doubleValue()) *(0.20)) * -1 ));//$JR_EXPR_ID=19$
            ...
            case 22 : 
            {
                value = (java.lang.Double)(new java.lang.Double(-1 *(((java.lang.Double)field_amount.getValue()).doubleValue() - ((java.lang.Double)variable_total.getValue()).doubleValue())));//$JR_EXPR_ID=22$
                break;
            }
            case 23 : 
            {
...
new java.lang.Double(  ((((java.lang.Double)variable_sub_total.getOldValue()).doubleValue()) *(0.20)) * -1 ));//$JR_EXPR_ID=19$
            ...
            case 22 : 
            {
                value = (java.lang.Double)(new java.lang.Double(-1 *(((java.lang.Double)field_amount.getOldValue()).doubleValue() - ((java.lang.Double)variable_total.getOldValue()).doubleValue())));//$JR_EXPR_ID=22$
                break;
            }
            case 23 : 
            {
...
new java.lang.Double(  ((((java.lang.Double)variable_sub_total.getEstimatedValue()).doubleValue()) *(0.20)) * -1 ));//$JR_EXPR_ID=19$
            ...
            case 22 : 
            {
                value = (java.lang.Double)(new java.lang.Double(-1 *(((java.lang.Double)field_amount.getValue()).doubleValue() - ((java.lang.Double)variable_total.getEstimatedValue()).doubleValue())));//$JR_EXPR_ID=22$
                break;
            }
            case 23 : 
            {
