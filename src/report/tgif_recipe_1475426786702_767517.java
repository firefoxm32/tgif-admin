/*
 * Generated by JasperReports - 10/2/16 11:46 PM
 */
 ...
 *
 */
public class tgif_recipe_1475426786702_767517 extends JREvaluator
{
...
new java.lang.Double(0.00));//$JR_EXPR_ID=19$
            ...
            case 24 : 
            {
                value = (java.lang.Double)(new java.lang.Double( ((java.lang.Double)variable_sub_total.getValue()).doubleValue() + ((java.lang.Double)variable_service_charge.getValue()).doubleValue() + (((java.lang.Double)variable_senior_citizen.getValue()).doubleValue() +((java.lang.Double)variable_member.getValue()).doubleValue()) ));//$JR_EXPR_ID=24$
                break;
            }
            case 25 : 
            {
...
new java.lang.Double(0.00));//$JR_EXPR_ID=19$
            ...
            case 24 : 
            {
                value = (java.lang.Double)(new java.lang.Double( ((java.lang.Double)variable_sub_total.getOldValue()).doubleValue() + ((java.lang.Double)variable_service_charge.getOldValue()).doubleValue() + (((java.lang.Double)variable_senior_citizen.getOldValue()).doubleValue() +((java.lang.Double)variable_member.getOldValue()).doubleValue()) ));//$JR_EXPR_ID=24$
                break;
            }
            case 25 : 
            {
...
new java.lang.Double(0.00));//$JR_EXPR_ID=19$
            ...
            case 24 : 
            {
                value = (java.lang.Double)(new java.lang.Double( ((java.lang.Double)variable_sub_total.getEstimatedValue()).doubleValue() + ((java.lang.Double)variable_service_charge.getEstimatedValue()).doubleValue() + (((java.lang.Double)variable_senior_citizen.getEstimatedValue()).doubleValue() +((java.lang.Double)variable_member.getEstimatedValue()).doubleValue()) ));//$JR_EXPR_ID=24$
                break;
            }
            case 25 : 
            {
