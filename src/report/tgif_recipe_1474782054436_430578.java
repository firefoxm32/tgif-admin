/*
 * Generated by JasperReports - 9/25/16 12:40 PM
 */
 ...
 *
 */
public class tgif_recipe_1474782054436_430578 extends JREvaluator
{
    ...
    public Object evaluate(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 8 : 
            {
                value = (java.lang.Double)(new java.lang.Double(((java.lang.Double)variable_service_charge.getValue()).doubleValue() + (((java.lang.Double)field_p.getValue()).doubleValue() * ((java.lang.Integer)field_qty.getValue()).doubleValue())));//$JR_EXPR_ID=8$
                break;
            }
            case 9 : 
            {
...
new java.lang.Double(  ((((java.lang.Double)variable_sub_total.getValue()).doubleValue()) *(0.20)) * -1 ));//$JR_EXPR_ID=19$
            ...
            case 22 : 
            {
                value = (java.lang.Double)(new java.lang.Double(  ((java.lang.Double)variable_total.getValue()).doubleValue() -((java.lang.Double)field_amount.getValue()).doubleValue() ));//$JR_EXPR_ID=22$
                break;
            }
            case 23 : 
            {
    ...
    public Object evaluateOld(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 8 : 
            {
                value = (java.lang.Double)(new java.lang.Double(((java.lang.Double)variable_service_charge.getOldValue()).doubleValue() + (((java.lang.Double)field_p.getOldValue()).doubleValue() * ((java.lang.Integer)field_qty.getOldValue()).doubleValue())));//$JR_EXPR_ID=8$
                break;
            }
            case 9 : 
            {
...
new java.lang.Double(  ((((java.lang.Double)variable_sub_total.getOldValue()).doubleValue()) *(0.20)) * -1 ));//$JR_EXPR_ID=19$
            ...
            case 22 : 
            {
                value = (java.lang.Double)(new java.lang.Double(  ((java.lang.Double)variable_total.getOldValue()).doubleValue() -((java.lang.Double)field_amount.getOldValue()).doubleValue() ));//$JR_EXPR_ID=22$
                break;
            }
            case 23 : 
            {
    ...
    public Object evaluateEstimated(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 8 : 
            {
                value = (java.lang.Double)(new java.lang.Double(((java.lang.Double)variable_service_charge.getEstimatedValue()).doubleValue() + (((java.lang.Double)field_p.getValue()).doubleValue() * ((java.lang.Integer)field_qty.getValue()).doubleValue())));//$JR_EXPR_ID=8$
                break;
            }
            case 9 : 
            {
...
new java.lang.Double(  ((((java.lang.Double)variable_sub_total.getEstimatedValue()).doubleValue()) *(0.20)) * -1 ));//$JR_EXPR_ID=19$
            ...
            case 22 : 
            {
                value = (java.lang.Double)(new java.lang.Double(  ((java.lang.Double)variable_total.getEstimatedValue()).doubleValue() -((java.lang.Double)field_amount.getValue()).doubleValue() ));//$JR_EXPR_ID=22$
                break;
            }
            case 23 : 
            {
